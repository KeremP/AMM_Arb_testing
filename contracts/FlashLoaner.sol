...
/**
* @title FlashLoaner
* @author KeremP (original implementation by Paco0x)
* Implements FlashSwap arbitrage contract. Originally written by Paco0x (https://github.com/paco0x)
* Edited and optimized by myslef, KeremP.
*/
